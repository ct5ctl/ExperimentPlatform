...
def process_sensor_data(sensor_data, vehicle_data, log_file):
    if sensor_data:
        ...
        with open(log_file, 'a') as file:
            file.write(f"speed: {speed}, steering_wheel_angle:{steering_wheel_angle}, pos_current: {vehicle_data.get_pos_current()}, theta_current: {vehicle_data.get_theta_current()}, speed: {speed}, wheel_angle: {wheel_angle}, steering_wheel_angle: {steering_wheel_angle}\n")
