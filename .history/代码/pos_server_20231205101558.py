...
def pos_calculation(speed, wheel_angle, last_moment_pos, last_moment_theta, time_slot=1):
    if speed != 0:
        ...
        next_pos_theta = last_moment_theta
...
def process_sensor_data(sensor_data, vehicle_data):
    if sensor_data:
        ...
        pos_current, theta_current = pos_calculation(float(speed), wheel_angle, vehicle_data.get_pos_current(), vehicle_data.get_theta_current())
        ...
        # if all([steering_wheel_direction, steering_wheel_angle, throttle_depth, brake_depth, speed, door_status]):
        #     print("方向盘方向:", steering_wheel_direction)
        #     print("方向盘角度:", steering_wheel_angle)
        #     print("油门深度:", throttle_depth)
        #     print("刹车深度:", brake_depth)
